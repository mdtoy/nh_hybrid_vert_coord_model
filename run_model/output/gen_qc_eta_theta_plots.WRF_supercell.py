...
g_method_isofl.legend = {0:'0',0.001:'1',0.002:'2',0.003:' 3 ',0.004:'4',0.005:'5',0.006:'6'}
...
for t in range(ntm):
	# Make graphic
	vcs_display = canvas1.isofill( qc_z[t:t+1,:,:], g_method_isofl, t_asd, ratio = '0.5t', yname='Height (km)',xname='x (km)', bg=1 )
	...
	fnametag = '0000' + str(t)
	filename = 'qc_eta_theta_' + fnametag[-4:]
